...
import LinterWorker from 'worker-loader?publicPath=/_bundler/&name=monaco-linter.[hash:8].worker.js!app/overmind/effects/vscode/LinterWorker';
import TypingsFetcherWorker from 'worker-loader?publicPath=/_bundler/&name=monaco-typings-ata.[hash:8].worker.js!./workers/fetch-dependency-typings';
