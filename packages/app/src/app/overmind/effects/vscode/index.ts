...
export class VSCodeEffect {
  ...
  public initialize(options: VsCodeOptions) {
    ...
    import(
      // @ts-ignore
      'worker-loader?publicPath=/_bundler/&name=client-ext-host-worker.[hash:8].worker.js!./extensionHostWorker/bootstrappers/client-ext-host'
    ...
    import(
      // @ts-ignore
      'worker-loader?publicPath=/_bundler/&name=container-ext-host-worker.[hash:8].worker.js!./extensionHostWorker/bootstrappers/container-ext-host'
    ).then(ExtHostWorkerLoader => {
